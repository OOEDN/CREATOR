...
import { Creator, Campaign, ContentItem, ContentStatus, TeamMessage, PaymentStatus } from '../../../shared/types';
import {
    DollarSign, CheckCircle, Upload, MessageCircle, Flame, ArrowRight, Bell, ChevronRight, Zap, Target, Trophy
} from 'lucide-react';
import { getLevel, getNextLevel, getLevelProgress, ACHIEVEMENTS } from '../../../shared/services/creatorXP';
