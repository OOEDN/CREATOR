...
import { Creator, CreatorStatus, PaymentMethod, Platform, CreatorRating, ContentItem, AppSettings, ShipmentStatus, PaymentOption, ReachPlatform, Shipment, CreatorAccount, ReachoutStatus } from '../../../shared/types';
...
import { RATING_COLORS, SHIPMENT_STATUS_COLORS, REACH_PLATFORM_COLORS } from '../../../shared/constants';
import ContentLibrary from './ContentLibrary';
import { draftCreatorOutreach } from '../../../shared/services/geminiService';
import { createGmailDraft } from '../../../shared/services/googleWorkspaceService';
import { analyzeSentiment } from '../../../shared/services/analysisService';
import ShipmentManager from './ShipmentManager';
import { sendPushNotification } from '../../../shared/services/pushService';
import { sendEmail } from '../../../shared/services/gmailService';
import { loadRemoteState, MasterDB } from '../../../shared/services/cloudSync';
import { uploadJSONToGoogleCloud } from '../../../shared/services/googleCloudStorage';
