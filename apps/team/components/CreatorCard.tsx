...
import { Creator, CreatorStatus, PaymentStatus, PaymentMethod, ShipmentStatus, ReachoutStatus } from '../../../shared/types';
import { PLATFORM_ICONS, STATUS_COLORS, RATING_COLORS, SHIPMENT_STATUS_COLORS, REACH_PLATFORM_COLORS } from '../../../shared/constants';
    ...
    `}>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {creator.reachoutStatus && creator.reachoutStatus !== ReachoutStatus.None && (
            <div className="text-[8px] bg-amber-500/10 text-amber-400 border border-amber-500/20 px-2 py-1 rounded-lg font-black uppercase tracking-widest">
              ✋ Reachout
            </div>
          )}
        </div>
